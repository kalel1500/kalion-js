...
const filesToCreate = [
    ...
    'resources/js/app.ts',
    'resources/js/config/bootstrap.ts',
    'resources/js/config/constants.ts',
    'resources/js/config/routes.ts',
    'resources/js/config/translations.ts',
    'resources/js/config/lang/es.json',
    'resources/js/config/lang/en.json',
    'resources/js/src/home/application/HomeUseCase.ts',
